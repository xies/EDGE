...
public class Vertex implements java.io.Serializable, Comparable<Vertex> {
	...
	public static float[][] coords(Vertex[] v) {
	...
	public static Vertex[] createVertices(float[][] coords) {
	...
	public void move(float[] newcoords) {
	...
	public static void drawConnection(float[][] image, Vertex v, Vertex w) {
