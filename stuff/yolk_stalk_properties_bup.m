...
nup = round(3/dz);     % select cell outline nup above lowest tracked
...
n_sel = min([round(6/dz) ntracked-nup]);    % number of z layers chosen to calculate tilt
...
% pre selection 
min_ysint_fac = 0.5; %intensity factor below which images are discarded
